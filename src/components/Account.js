...
function Account(props) {
    return(
        <div className="account-section" style={{ height: '100vh', width: '100vw', backgroundColor: 'blue', display: 'flex', alignItems: 'center', justifyContent: 'space-around' }}>
            <div className="icon-buttons" style={{ width: '25%', height: '80vh', backgroundColor: 'red', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', alignItems: 'center'}}>
                {/* Three div elements below show how icon buttons will be positioned */}
                <div style={{ height: '30%', width: '80%', backgroundColor: 'green' }} />
                <div style={{ height: '30%', width: '80%', backgroundColor: 'green' }} />
                <div style={{ height: '30%', width: '80%', backgroundColor: 'green' }} />
            </div>
            <div className="currently-section" style={{ width: '65%', height: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-around', alignItems: 'center' }}>
